...
<li>⚙️ Experienced in Node.js, .NET, and TypeScript ecosystems</li>
<li>☁️ Working with Azure and cloud-based solutions</li>
...
**Databases & Caching** 
- PostgreSQL, MySQL, MongoDB, Redis, MS SQL Server

**Architecture & Tools** 
- Microservices, REST APIs, Queue-based systems (BullMQ)
- Docker, Git, Postman
